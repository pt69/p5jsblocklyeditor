...
Blockly.Blocks['istInputEineZahl'] = {
  init: function() {
    this.appendValueInput("input")
        .setCheck(null);
    this.appendDummyInput()
        .appendField("ist eine Zahl!");        
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setColour(farbeMathe);
 this.setTooltip("Liefert wahr, wenn Variable eine Zahl ist, sonst falsch.");
 this.setHelpUrl("");
  }
};

Blockly.JavaScript['istInputEineZahl'] = function(block) {
  var value_input = Blockly.JavaScript.valueToCode(block, 'input', Blockly.JavaScript.ORDER_ATOMIC);
  var code = '!isNaN(' + extrahiereCode(value_input) + ')';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};